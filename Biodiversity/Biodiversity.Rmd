...
Now, try to modify the above code to calculate the mean body mass of all penguin species by island. After trying, check your answer by viewing the solution. 
...
Modify the above code to plot the bill length (bill_length_mm) versus the bill depth (bill_depth_mm). After trying, you can check your answer by viewing the solution. 
...
The Simpson index... It is calculated as:
$$D = 1-\sum_{i=1}^Sp_i^2$$
